exports.run = (client, message, args) => {
    ...
    {
        client.logger.write(client.moment().format("DD/MM/YYYY HH:mm") + " [Nickname]      : " + message.author.tag + " changed: " + message.guild.members.get(tagID).user.tag + "'s nickname to: \"" +  mess.join(" ") + "\"\n");
